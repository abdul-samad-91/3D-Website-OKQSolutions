    ...
    <section style={{ background: "linear-gradient(135deg, #FFFFFF 0%, #FDFEFE 8.33%, #FAFDFE 16.67%, #F8FCFD 25%, #F5FBFC 33.33%, #F3FAFC 41.67%, #F0F9FB 50%, #EEF9FB 62.5%, #ECF8FB 75%, #EAF8FA 87.5%, #E8F7FA 100%)" }} className="overflow-hidden">
      <div className="max-w-6xl mx-auto px-6 grid lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="flex flex-col gap-6">
          ...
          <h1 className="text-[2.75rem] lg:text-[50px] font-semibold leading-[1.1] text-[#0d1b2a]">
      ...
      <div className="mt-10 bg-[#28A9BD] text-white shadow-[0_-1px_0_rgba(255,255,255,0.45)_inset]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 pt-3 pb-2">
          <p className="text-center text-[10px] font-bold tracking-[0.22em] uppercase leading-none">
          ...
          <div className="mt-3 flex items-center gap-6 overflow-x-auto whitespace-nowrap pb-1 [scrollbar-width:none] [&::-webkit-scrollbar]:hidden lg:justify-between lg:gap-3">
            {standards.map((standard) => (
              <div
                key={standard.id}
                className="flex shrink-0 items-center gap-2 text-[10px] font-semibold leading-none"
              >
