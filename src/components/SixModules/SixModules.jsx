    ...
    <section className="bg-white px-6 py-16 lg:py-20">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="relative hidden lg:block h-[360px]">
          ...
          >
            <path
              d="M78 164C83 66 173 39 285 104C390 165 438 247 576 258C722 269 855 248 970 118C1018 64 1060 56 1110 74"
              stroke="#00A8C8"
              strokeWidth="1.35"
              strokeLinecap="round"
            />
        ...
        <div className="mt-8 rounded-lg bg-[linear-gradient(135deg,#12B8C8_0%,#058FA3_100%)] px-8 py-8 text-white lg:px-10">
          <div className="flex gap-5">
            <svg xmlns="http://www.w3.org/2000/svg" className="mt-1 h-6 w-6 shrink-0" fill="white" viewBox="0 0 24 24">
        ...
        <div className="mt-10 text-center">
          <p className="text-[18px] lg:text-[20px] font-bold italic text-[#0d1b2a]">
          ...
          <div className="mt-5 flex flex-wrap items-center justify-center gap-2 text-[12px] text-[#59666B]">
            ...
            {kpiItems.map((item) => (
              <span key={item} className="rounded-full border border-[#D8E4E8] bg-[#F8FBFC] px-4 py-1.5">
                {item}
              </span>
            ))}
          </div>
          ...
          <a
            href="#competency"
            className="mt-6 inline-flex rounded-md bg-[#00A8C8] px-10 py-3 text-[13px] font-bold text-white transition-colors hover:bg-[#058FA3]"
          >
